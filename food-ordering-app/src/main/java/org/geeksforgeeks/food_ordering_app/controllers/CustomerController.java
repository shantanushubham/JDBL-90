...
public class CustomerController {
    ...
    @GetMapping
    public ResponseEntity<?> getCustomer(@AuthenticationPrincipal CustomUserDetails customUserDetails) {
        try {
            Customer customer = this.customerService.getCustomerById(customUserDetails.getCustomer().getId());
